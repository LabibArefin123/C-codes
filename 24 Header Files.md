...
which comes along with your compiler.

# Including a header file is equal to copying the content of the header file but we do not do it
# because it will be error-prone and it is not a good idea to copy the content of a header file in the source files, especially if we have multiple source files in a program.
